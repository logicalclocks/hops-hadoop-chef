...
echo export HADOOP_INSTALL=#{node[:hadoop][:dir]}/hadoop >> /home/#{username}/.bash_profile
# '' (single quoting) a string causes its variables not to be dereferenced
echo 'export PATH=\$PATH:#{node[:hadoop][:dir]}/hadoop/bin' >> /home/#{username}/.bash_profile
# \\ has the same effect as a single '\' on singly quoted string
echo export PATH=\\$PATH:#{node[:hadoop][:dir]}/hadoop/sbin >> /home/#{username}/.bash_profile
echo export HADOOP_MAPRED_HOME=#{node[:hadoop][:dir]}/hadoop >> /home/#{username}/.bash_profile
echo export HADOOP_COMMON_HOME=#{node[:hadoop][:dir]}/hadoop >> /home/#{username}/.bash_profile
echo export HADOOP_HDFS_HOME=#{node[:hadoop][:dir]}/hadoop >> /home/#{username}/.bash_profile
echo export YARN_HOME=#{node[:hadoop][:dir]}/hadoop >> /home/#{username}/.bash_profile
echo export HADOOP_HOME=#{node[:hadoop][:dir]}/hadoop >> /home/#{username}/.bash_profile
