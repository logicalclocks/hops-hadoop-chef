...
sudo -u hduser yarn jar ./share/hadoop/yarn/hadoop-yarn-applications-distributedshell-2.2.0.jar -jar ./share/hadoop/yarn/hadoop-yarn-applications-distributedshell-2.2.0.jar org.apache.hadoop.yarn.applications.distributedshell.Client -num_containers 2 -container_memory 2048 -shell_command whoami -master_memory 1024
